    ...
    <>
      <div className="flex items-center justify-between p-4 relative">
        ...
        <span id="upgrade" className="absolute top-0 right-1/2">
          <div class="inline-flex items-center gap-1 rounded-full text-sm font-medium py-2 pe-2 bg-[#F1F1FB] text-[#5D5BD0] hover:bg-[#E4E4F6] dark:bg-[#373669] dark:text-[#DCDBF6] dark:hover:bg-[#414071]">
            <button
              type="button"
              class="flex items-center gap-1 bg-transparent ps-2.5 text-current focus:outline-none pe-0"
            >
              <svg
                width="20"
                height="20"
            ...
            <button
              type="button"
              class="ms-0 flex h-4 w-4 items-center justify-center rounded-full text-[black] hover:bg-[#E4E4F6] dark:text-[white] dark:hover:bg-[#414071] transform transition-all duration-200 ease-out pointer-events-auto visible translate-x-0 opacity-100"
